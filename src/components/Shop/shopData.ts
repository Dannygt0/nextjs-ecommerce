...
const shopData: Product[] = [
  ...
  },
  {
    ...
    id: 9,
    imgs: {
      thumbnails: ["/images/products/product-9-bg-1.png", "/images/products/product-9-bg-2.png"],
      previews: ["/images/products/product-9-bg-1.png", "/images/products/product-9-bg-2.png"],
    },
  },
  {
    ...
    id: 10,
    imgs: {
      thumbnails: ["/images/products/product-10-bg-1.png", "/images/products/product-10-bg-2.webp"],
      previews: ["/images/products/product-10-bg-1.png", "/images/products/product-10-bg-2.webp"],
    },
  },
];
