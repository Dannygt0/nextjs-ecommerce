...
const shopData: Product[] = [
  {
    ...
    description:
      "Experience next-level gaming with the Havit HV-G69 USB Gamepad. Features ergonomic design, precise joysticks, and dual-vibration feedback for immersive gameplay.",
    rating: 4.5,
    reviews: 15,
    price: 59.0,
  ...
  },
  {
    ...
    description:
      "The iPhone 14 Plus features a supersized Super Retina XDR display, advanced camera system for better low-light photos, and all-day battery life.",
    rating: 4.8,
    reviews: 5,
    price: 899.0,
  ...
  },
  {
    ...
    category: "Laptop & PC",
    description:
      "Brilliant 24-inch 4.5K Retina display. Powered by the Apple M1 chip for stellar performance. Incredibly thin design in vibrant colors.",
    rating: 4.9,
    reviews: 5,
    price: 59.0,
    discountedPrice: 29.0,
  ...
  },
  {
    ...
    category: "Watches",
    description:
      "The most rugged and capable Apple Watch ever, designed for exploration, adventure, and endurance. With a 49mm aerospace-grade titanium case.",
    rating: 5.0,
    reviews: 3,
    price: 99.0,
    discountedPrice: 29.0,
  ...
  },
  {
    ...
    category: "Laptop & PC",
    description:
      "Ultrafast magspeed scrolling - remarkable speed, precision & quietness of electromagnetic scrolling with all-new magspeed wheel.",
    rating: 4.8,
    reviews: 15,
    price: 59.0,
    discountedPrice: 29.0,
  ...
  },
  {
    ...
    category: "Mobile & Tablets",
    description:
      "Supercharged by the Apple M1 chip. 10.9-inch Liquid Retina display with True Tone, P3 wide color, and an antireflective coating.",
    rating: 4.6,
    reviews: 15,
    price: 59.0,
    discountedPrice: 29.0,
  ...
  },
  {
    ...
    category: "Laptop & PC",
    description:
      "Dual-band WiFi 6 (802.11ax) router with MU-MIMO and OFDMA technology for better efficiency and throughput. Perfect for high-speed gaming.",
    rating: 4.3,
    reviews: 15,
    price: 59.0,
    discountedPrice: 29.0,
  ...
  },
  {
    ...
    category: "Mobile & Tablets",
    description:
      "The future of smartphones. Features a revolutionary edge-to-edge holographic display, advanced AI integration, and a titanium build.",
    rating: 4.9,
    reviews: 15,
    price: 1300.0,
  ...
  },
  {
    ...
    category: "Mobile & Tablets",
    description:
      "Unleash your creativity with the integrated S-Pen, quad-camera setup with 200x space zoom, and a massive battery that lasts days.",
    rating: 4.8,
    reviews: 16,
    price: 1300.0,
    discountedPrice: 1199.99,
