          ...
          <div className="flex items-center justify-center gap-2.5 mb-2">
            ...
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((starIndex) => {
                ...
                const gradientId = `single-star-gradient-${item.id}-${starIndex}`;

                if (rating >= starIndex) {
                  return (
                    <svg key={starIndex} width="14" height="14" viewBox="0 0 24 24" fill="#FFA41C" stroke="#FFA41C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  return (
                    <svg key={starIndex} width="14" height="14" viewBox="0 0 24 24" fill={`url(#${gradientId})`} stroke="#FFA41C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <defs>
                  ...
                  return (
                    <svg key={starIndex} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FFA41C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                    </svg>
                  );
                }
